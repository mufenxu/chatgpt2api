...
from services.auth_service import QuotaExceededError
...
def create_router() -> APIRouter:
    ...
    async def create_generation_task(
        ...
        identity = require_identity(authorization)
        model = body.model if identity.get("role") == "admin" else "gpt-image-2"
    ...
    async def create_edit_task(
        ...
        model = str(payload["model"]) if identity.get("role") == "admin" else "gpt-image-2"
